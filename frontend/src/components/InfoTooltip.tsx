...
const InfoTooltip: React.FC<InfoTooltipProps> = ({ title, description, optimalRange, timestamp }) => {
  ...
  return (
    <div className="group relative inline-block">
      ...
      <div className="absolute top-full left-1/2 transform -translate-x-1/2 mt-2 hidden group-hover:block w-64 bg-gray-800 text-white text-xs rounded-lg p-2 z-50">
